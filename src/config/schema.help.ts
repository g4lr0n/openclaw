...
export const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.bind":
    'Network bind profile: "auto", "lan", "loopback", "custom", "tailnet", or "doxxnet" to control interface exposure. Keep "loopback" or "auto" for safest local operation unless external clients must connect.',
